...
class PyZigBeeBadFormat(PyZigBeeException):
    """
    Raised when bad format is encountered
    """

    def __init__(self, msg, detail=None):
        super(PyZigBeeBadFormat, self).__init__(msg=msg, detail=detail)
...
class PyZigBeeNotSupported(PyZigBeeException):
    """
    Raised when a operation is not supported
    """

    def __init__(self, msg, detail=None):
        super(PyZigBeeNotSupported, self).__init__(msg=msg, detail=detail)
